...
{HideCharacter("Player")} {ShowCharacter("Sebastian", "Right", "Normal")} Exactly. Just little guys, minding their business. Living the dream. You should come wwith me to bring this up to Linda. There could be a serious issue.
~SebastianTrust += 10
-> END
