...
{HideCharacter("Bruce")} {ShowCharacter("Player", "Right", "Suspicious")} ...What happened?
...
{HideCharacter("Bruce")} {ShowCharacter("Player", "Right", "Normal")} What kind of charm?
{HideCharacter("Player")} {ShowCharacter("Bruce", "Right", "Suspicious")} A fresh daisy.  
{HideCharacter("Bruce")} {ShowCharacter("Player", "Right", "Happy")} ... 
