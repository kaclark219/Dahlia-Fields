...
{HideCharacter("Player")} {ShowCharacter("Jeremy", "Right", "Happy")} Bro, I don't know if I've mentioned it, but I’ve got a pristine condition PSA 10 First Edition Shiny Magikarp. You wouldn’t believe how many wisps that thing is worth.
~JeremyTrust += 10
-> END
