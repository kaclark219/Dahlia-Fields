...
{HideCharacter("Player")} {ShowCharacter("Gerald", "Right", "Normal")} Unfortunately, that won't for anatomy sketches in my journal. They have to be pretty detailed to be helpful to anyone else. Thank you for trying, though.
~GeraldTrust += 10
-> END
