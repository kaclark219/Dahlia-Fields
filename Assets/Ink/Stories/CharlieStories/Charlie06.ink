...
{HideCharacter("Charlie")} {ShowCharacter("Player", "Right", "Normal")} As much as I'd like the ebusiness, a few flowers might not fix that problem.
...
{HideCharacter("Charlie")} {ShowCharacter("Player", "Right", "Normal")} You do realize flowers won’t cancel out garbage, right?  
